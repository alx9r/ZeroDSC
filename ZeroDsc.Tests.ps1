...
Import-Module ZeroDsc

$here = Split-Path -Parent $MyInvocation.MyCommand.Path

$manifestPath   = "$here\ZeroDsc.psd1"
...
Describe "manifest and changelog" {
    ...
    It "has a valid name in the manifest" {
        $script:manifest.Name | Should Be ZeroDsc
    }

    It "has a valid guid in the manifest" {
        $script:manifest.Guid | Should Be '64410c3c-434f-4ce7-b9c2-3a056f0a1831'
    }
...
Describe 'Style rules' {
    $moduleRoot = (Get-Module ZeroDsc).ModuleBase
